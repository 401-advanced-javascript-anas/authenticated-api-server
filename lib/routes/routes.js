...
router.get('/api/v1/:model', bearerMiddleware, permissions('read'), showHandler);
router.get('/api/v1/:model/:id', bearerMiddleware, permissions('read'), getHandler);
router.post('/api/v1/:model', bearerMiddleware, permissions('create'), postHandler);
router.put('/api/v1/:model/:id', bearerMiddleware, permissions('update'), putHandler);
router.delete('/api/v1/:model/:id', bearerMiddleware, permissions('delete'), deleteHandler);
